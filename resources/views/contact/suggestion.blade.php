...
@section('title', 'Öneri Formu')

@section('content')
    <section class="container mx-auto py-12 px-6">
        <h1 class="text-4xl font-bold text-gray-900 mb-8">Öneri Formu</h1>
        ...
        <form action="{{ route('suggestion.store') }}" method="POST" class="bg-white rounded-xl p-8 shadow-md">
            @csrf
